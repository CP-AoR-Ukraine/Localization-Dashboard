...
var prcchart = document.getElementById("PRC");
var TCSA = new Chart(tcsachart, {
  type: 'bar',
  data: {
    labels: ["General Programatic", "Organisational or Operational", "Technical Child Protection", "Other"],
    datasets: [{
      data: [38,24,26,12],
